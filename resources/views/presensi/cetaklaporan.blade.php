...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/logotok.png') }}" width="90" height="90" alt="">
                </td>
                <td>
                    <span id="title">
                        LAPORAN PRESENSI KARYAWAN PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        PT.BPR GUNUNG SLAMET<br>
                    </span>
                    <span><i>Jl. Dr. Wahidin Sudiro Husodo No.31 Kec. Sidakaya Kec. Cilacap Selatan (0282) 532871</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td colspan="2" style="text-align: right">Cilacap, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
