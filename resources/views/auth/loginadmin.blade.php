...
<head>
    ...
    <title>Login Dashboard - Admin Joemen</title>
    <!-- CSS files -->
        ...
        <div class="container container-normal py-4">
            <div class="row align-items-center g-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/prosesloginadmin" method="post" autocomplete="off" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Masukan email" autocomplete="off">
                                    </div>
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group input-group-flat">
                                            ...
                                            <span class="input-group-text">
                                                <a href="#" class="link-secondary" title="Lihatkan password" data-bs-toggle="tooltip">
                ...
                <div class="col-lg d-none d-lg-block">
                    <img src="{{ asset('tabler/static/illustrations/undraw_two_factor_authentication_namy.svg') }}" height="300" class="d-block mx-auto" alt="">
                </div>
            </div>
        </div>
    </div>
